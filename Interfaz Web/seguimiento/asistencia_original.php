            ...
            <tbody>
                <?php foreach ($usuarios_asistencia as $usuario_asistencia) : ?>
                    <tr>
                        ...
                        <td class="actions">
                            <a href="editar_asistencia.php?id=<?= $usuario_asistencia['ID_Asistencia'] ?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                            <a href="eliminar_asistencia.php?id=<?= $usuario_asistencia['ID_Asistencia'] ?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
